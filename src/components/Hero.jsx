export default function Hero({ onBookClick }) {
  ...
  return (
    <section
      id="hero"
      className="relative w-full min-h-[90vh] flex items-center justify-center overflow-hidden pt-[68px]"
    >
      <div
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 py-16 text-center">
        <span
          className="inline-block px-4 py-1.5 rounded-full text-xs tracking-widest font-medium mb-6
        ...
        <h1
          className="font-heading font-bold leading-tight mb-2 text-theme
        ...
        <p
          className="mt-6 mb-8 text-base sm:text-lg text-muted max-w-xl mx-auto leading-relaxed
          opacity-0 animate-[fadeUp_0.8s_ease_0.7s_forwards]"
        >
          Compassionate online therapy for individuals, couples, and families. A
          dedicated space to heal, grow, and reconnect from the comfort of your
          home.
        </p>
        ...
        <p
          className="mt-5 text-xs text-faint tracking-wide
