      ...
      <div className="container-custom">
        <div className="reveal text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-muted text-lg leading-relaxed">
            Take the first step towards healing and growth. Schedule your
            50-minute online therapy session today.
          </p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="reveal from-left space-y-6">
            ...
            >
              <h3 className="font-heading font-semibold text-theme text-xl mb-6">
                Session Details
              </h3>
              {[
                {
            ...
            <div
              ...
              style={{
                ...
                border: "2px solid rgba(201,122,99,0.2)",
              }}
            >
              <h3 className="font-heading font-semibold text-theme text-lg mb-4">
                What to Expect
              </h3>
              <ul className="space-y-2">
                {[
                  "Confirmation email within 24 hours",
                  "Secure video link sent before your session",
                  "Confidential and HIPAA-compliant platform",
          ...
          <div className="reveal from-right">
            {state.succeeded ? (
              <div
                className="rounded-3xl p-8 flex flex-col items-center justify-center gap-4 py-16"
                style={{
              ...
              >
                ...
                <h3 className="font-heading font-bold text-theme text-2xl">
                  Booking Request Sent!
                </h3>
                <p className="text-muted text-center">
                  Thank you! We will contact you within 24 hours to confirm your
                  session.
                </p>
              </div>
            ) : (
              ...
              >
                <div>
                  <label className="block text-xs font-semibold uppercase tracking-wide text-theme mb-1.5">
                    Full Name *
                  </label>
                  <input
                    type="text"
                    ...
                    required
                    className="w-full px-4 py-3 rounded-xl text-sm outline-none font-body"
                    style={inputStyle}
                  />
                  <ValidationError
                    field="clientName"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label
                      ...
                      className="block text-xs font-semibold uppercase tracking-wide text-theme mb-1.5"
                    >
                      Preferred Date *
                    </label>
                    <input
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-2xl text-sm outline-none font-body resize-none"
                    style={inputStyle}
                  />
                </div>
                <button
