  ...
  return (
    ...
    >
      ...
      <div className="p-8 flex flex-col flex-1">
        <h3 className="font-heading font-bold text-theme text-xl mb-3">
          {service.name}
        </h3>
      ...
      <div className="container-custom">
        <div className="reveal text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-muted text-lg leading-relaxed">
            Tailored therapeutic approaches designed to meet you exactly where
            you are, whether you're seeking individual clarity or relational
            harmony.
          </p>
        </div>
