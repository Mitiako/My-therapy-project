...
export default function Modal({ isOpen, serviceType, onClose }) {
  ...
  return (
    ...
    >
      <div
        className="modal-enter rounded-3xl w-full max-w-lg max-h-[90vh] overflow-y-auto"
        style={{
      ...
      >
        <div className="flex items-start justify-between p-8 pb-0">
          <div>
            <h2 className="font-heading font-bold text-theme text-2xl">
              Book a Session
            </h2>
        ...
        <div className="p-8">
          {state.succeeded ? (
            <div className="flex flex-col items-center gap-4 py-8">
              ...
              <h3 className="font-heading font-bold text-theme text-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-xs text-faint text-center">
                * Required fields · We will confirm within 24 hours
              </p>
            </form>
          )}
        </div>
