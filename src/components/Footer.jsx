...
const legal = [
  {
    ...
    href: "https://docs.google.com/document/d/1YbtLDygmy0Uu2FceE53X51ZizoxQcSRSLOVtIWW1ByI/preview",
  },
  {
    label: "Terms of Service",
    href: "https://docs.google.com/document/d/1ysm7HVlVsMph4Xyg_Ah5iqBQokrI2hH0xP2qYVYueIk/preview",
  },
...
export default function Footer() {
  ...
  return (
    <footer
      ...
      style={{ background: "#1a2e2e", color: "rgba(255,255,255,0.75)" }}
    >
      <div className="max-w-container mx-auto grid grid-cols-1 lg:grid-cols-[2fr_1fr_1fr] gap-12">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-white/12 flex items-center justify-center font-heading font-bold text-white">
              H
            </div>
          ...
          <p className="text-sm leading-relaxed max-w-xs">
            Professional online therapy for individuals, couples, and families.
            Creating a safe space for healing and growth.
          </p>
          <span className="inline-block px-3 py-1 border border-white/20 rounded-full text-xs text-white/50 w-fit">
            Licensed in Texas
          </span>
          ...
          <div className="flex flex-col gap-2 mt-2">
            ...
            >
              ...
              <span className="transition-colors duration-300 group-hover:text-[#E1306C]">
                @harmonia_vitalis
              </span>
            </a>
          </div>
      ...
      <div
        className="max-w-container mx-auto mt-10 pt-8 flex flex-col sm:flex-row justify-between items-center gap-2 text-xs text-white/35"
